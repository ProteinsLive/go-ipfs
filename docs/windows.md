...
cd %GOPATH%/src/github.com/ProteinsLive/go-ipfs/cmd/ipfs
```
...
If you encounter a bug with `go-ipfs` itself (not related to building) please use the [issue tracker](https://github.com/ProteinsLive/go-ipfs/issues) to report it.
