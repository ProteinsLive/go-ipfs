...
import (
	...
	keystore "github.com/ProteinsLive/go-ipfs/keystore"
	repo "github.com/ProteinsLive/go-ipfs/repo"
	"github.com/ProteinsLive/go-ipfs/repo/common"
	mfsr "github.com/ProteinsLive/go-ipfs/repo/fsrepo/migrations"
	dir "github.com/ProteinsLive/go-ipfs/thirdparty/dir"
...
func (r *FSRepo) openDatastore() error {
	...
	if r.config.Datastore.NoSync {
		log.Warning("NoSync is now deprecated in favor of datastore specific settings. If you want to disable fsync on flatfs set 'sync' to false. See https://github.com/ProteinsLive/go-ipfs/blob/master/docs/datastores.md#flatfs.")
	}
