...
[config](https://github.com/ProteinsLive/go-ipfs/blob/master/docs/config.md#gateway)
documentation.
...
`go-get=1` parameter. See [PR#3964](https://github.com/ProteinsLive/go-ipfs/pull/3963)
for details</sub>
